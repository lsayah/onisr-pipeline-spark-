...
Mon projet du jour 4 de la formation Spark. Je pars des CSV bruts d'accidents corporels ONISR 2024, je nettoie tout ça, je fais 3 analyses en SQL, une optimisation mesurée (broadcast join), et une exploration sur le partition pruning / predicate pushdown.
...
output/silver/        -> la couche Parquet nettoyee, partitionnée par département
output/gold/          -> les resultats des 3 analyses en CSV
