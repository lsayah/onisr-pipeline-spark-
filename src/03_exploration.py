...
print("\n  Avec AQE, Spark ajuste le nombre de partitions shuffle tout seul.")
print("  Sur ce petit volume l'effet se voit a peine, mais sur un vrai gros")
print("  volume ca evite de creer des milliers de partitions vides apres un groupBy.")
...
print("  faut que j'aille sur localhost:4040 avant de fermer la session")
print("  onglet Jobs, job FileScan, je regarde 'number of files read'")
print("  et je compare Test1 (tous les fichiers) avec Test2 (1 fichier dep=75)")
print("=" * 60)
